...
由于平台资源有限，且硬件平台多样，因此需要屏蔽不同硬件架构和资源的不同、以及运行形态的不同，提供统一化的系统服务开发框架。根据RISC-V、Cortex-M、Cortex-A不同硬件平台，分为两种硬件平台，以下简称M核、A核。
...
![](http://tools.harmonyos.com/mirrors/hpm-image/system_ability_manager_README/figures/zh-cn_image_0000001051351505.png)
...
![](http://tools.harmonyos.com/mirrors/hpm-image/foundation_README/figures/zh-cn_image_0000001051990283.png)
